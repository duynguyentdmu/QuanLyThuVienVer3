...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Hiển thị từ mục _START_ đến mục _END_ của tất cả _TOTAL_ mục",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Được lọc ra từ tổng _MAX_  mục)",
			 ...
			 */
			/**
			 Chi tiết hành động sẽ được thực hiện khi trình đơn thả xuống cho
			 * tùy chọn độ dài phân trang được thay đổi. Biến '_MENU_' được thay thế
			 * với danh sách chọn mặc định là 10, 25, 50 và 100 và có thể được thay thế
			 * với hộp chọn tùy chỉnh nếu cần.
			 * chuỗi @type
			 * @default Hiển thị các mục _MENU_
			 *
			 * @dtopt Ngôn ngữ
			 * @name DataTable.defaults.l Language.lengthMothy
			 *
			 * @thí dụ
			 * // Chỉ thay đổi ngôn ngữ
			 * $ (tài liệu). yet (function () {
			 * $ ('# ví dụ'). dataTable ({
			 * "ngôn ngữ": {
			 * "lengthMothy": "Hiển thị các bản ghi _MENU_"
			 *}
			 *});
			 *});
			 *
			 * @thí dụ
			 * // Ngôn ngữ và tùy chọn thay đổi
			 * $ (tài liệu). yet (function () {
			 * $ ('# ví dụ'). dataTable ({
			 * "ngôn ngữ": {
			 * "lengthMothy": 'Hiển thị <select>' +
			 * '<tùy chọn giá trị = "10"> 10 </ tùy chọn>' +
			 * '<tùy chọn giá trị = "20"> 20 </ tùy chọn>' +
			 * '<tùy chọn giá trị = "30"> 30 </ tùy chọn>' +
			 * '<tùy chọn giá trị = "40"> 40 </ tùy chọn>' +
			 * '<tùy chọn giá trị = "50"> 50 </ tùy chọn>' +
			 * '<tùy chọn giá trị = "- 1"> Tất cả </ tùy chọn>' +
			 * '</ select> hồ sơ'
			 *}
			 *});
			 *});
			...
			*/
			 ...
			 *    } );
			 */
			"sZeroRecords": "Không tìm thấy dữ liệu cần tìm kiếm! Vui lòng thử lại."
		},
